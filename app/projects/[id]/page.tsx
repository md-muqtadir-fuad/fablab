...
export default async function ProjectDetail({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <article className="mx-auto max-w-5xl px-4 py-14 sm:px-6 lg:py-20">
      ...
      <div className="relative mt-6 aspect-[16/8] overflow-hidden border border-neutral-300 bg-neutral-200"><Image src={project.image} alt={project.title} fill sizes="(max-width: 1024px) 100vw, 1024px" priority className="object-cover" /></div>
      <div className="mx-auto max-w-3xl py-10">
        ...
        <p className="mt-8 text-lg leading-8 text-neutral-700">This project used Advanced Fabrication Lab facilities to move from early design to a tested physical prototype. The team combined {project.technologies.join(", ")} in an iterative build-and-test workflow.</p>
