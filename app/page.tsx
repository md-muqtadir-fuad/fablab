...
export default function Home() {
  return (
    <div className="w-full overflow-hidden">
      ...
      <section className="py-16 sm:py-20 lg:py-28"><div className="section-shell grid gap-10 lg:grid-cols-[.75fr_1.25fr] lg:gap-20">
      ...
      <section className="bg-[#2b060d] py-16 text-white sm:py-20 lg:py-28"><div className="section-shell">
      ...
      <section className="bg-[#eee8df] py-16 sm:py-20 lg:py-28"><div className="section-shell"><div className="grid overflow-hidden rounded-xl bg-buet-red lg:grid-cols-[1.05fr_.95fr]">
        ...
        <div className="relative order-1 min-h-[260px] sm:min-h-[340px] lg:order-2 lg:min-h-full"><Image src="/images/industry.webp" alt="Industry partners working with a fabrication team" fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover" /></div>
      </div></div></section>
    </div>
  );
}
