...
export function RequestPage({ title, intro, subject, submitLabel }: { title: string; intro: string; subject: string; submitLabel?: string }) {
  return (
    <div className="py-12 sm:py-16 lg:py-24">
      <div className="section-shell grid gap-9 lg:grid-cols-[.72fr_1.28fr] lg:gap-20">
        <div>
          ...
          <p className="eyebrow mt-9 sm:mt-12">Send a request</p>
        ...
        <div><EnquiryForm subject={subject} submitLabel={submitLabel} /></div>
      </div>
    </div>
  );
}
